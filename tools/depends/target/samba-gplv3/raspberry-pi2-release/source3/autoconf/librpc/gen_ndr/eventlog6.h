...
struct eventlog6_EvtRpcGetChannelList {
	...
	struct {
		...
		const char ***channelPaths;/* [charset(UTF16),ref,range(0,MAX_RPC_CHANNEL_COUNT),size_is(,*numChannelPaths)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherList {
	...
	struct {
		...
		const char ***publisherIds;/* [ref,range(0,MAX_RPC_PUBLISHER_COUNT),size_is(,*numPublisherIds),charset(UTF16)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherListForChannel {
	...
	struct {
		uint32_t *numPublisherIds;/* [ref] */
		const char ***publisherIds;/* [charset(UTF16),ref,range(0,MAX_RPC_PUBLISHER_COUNT),size_is(,*numPublisherIds)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetEventMetadataEnum {
	struct {
		struct policy_handle *pubMetadata;/* [ref] */
		uint32_t flags;
		const char *reservedForFilter;/* [range(0,MAX_RPC_FILTER_LENGTH),charset(UTF16),unique] */
	} in;
