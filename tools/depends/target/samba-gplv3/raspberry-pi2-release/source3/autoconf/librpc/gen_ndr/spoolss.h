...
struct spoolss_DeviceMode {
	...
	DATA_BLOB driverextra_data;/* [subcontext(0),flag(LIBNDR_FLAG_REMAINING),subcontext_size(__driverextra_length)] */
}/* [public,gensize] */;
...
}/* [nodiscriminant,gensize,public,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE)] */;
...
}/* [nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base,public,gensize] */;
...
struct spoolss_DriverInfo101 {
	...
	const char * driver_name;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2)] */
	const char * architecture;/* [flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2),relative] */
	struct spoolss_DriverFileInfo *file_info;/* [size_is(file_count),flag(LIBNDR_FLAG_ALIGN4),relative] */
	uint32_t file_count;
	const char * monitor_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2),relative] */
	const char * default_datatype;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2)] */
	const char ** previous_names;/* [flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2),relative] */
...
}/* [nodiscriminant,public,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),gensize] */;
...
}/* [nodiscriminant,relative_base,public,flag(LIBNDR_FLAG_RELATIVE_REVERSE),gensize] */;
...
struct spoolss_OSVersionEx {
	...
	uint32_t build;
	uint32_t platform_id;/* [value(2)] */
	const char * extra_string;/* [subcontext(0),subcontext_size(256),flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2)] */
...
struct spoolss_AddMonitorInfo2 {
	...
	const char *dll_name;/* [unique,charset(URF16)] */
};

union spoolss_AddMonitorInfo {
	struct spoolss_AddMonitorInfo1 *info1;/* [unique,case] */
...
struct spoolss_NotifyOptionType {
	...
	uint32_t u3;
	uint32_t count;
	union spoolss_Field *fields;/* [switch_is(type),unique,size_is(count)] */
};
...
struct spoolss_PrinterEnumValues {
	...
	DATA_BLOB *data;/* [relative,subcontext_size(data_length),flag(LIBNDR_FLAG_REMAINING|ndr_spoolss_PrinterEnumValues_align(r->type)),subcontext(0)] */
...
struct RPC_BINARY_CONTAINER {
	uint32_t cbBuf;
	uint8_t *pszString;/* [unique,size_is(cbBuf)] */
};

union RPC_BIDI_DATA_u {
	uint32_t bData;/* [case(BIDI_NULL)] */
	uint32_t iData;/* [case(BIDI_INT)] */
	const char *sData;/* [charset(UTF16),unique,case(BIDI_STRING)] */
...
union RPC_PrintPropertyValueUnion {
	const char *propertyString;/* [unique,charset(UTF16),case(kRpcPropertyTypeString)] */
...
}/* [ms_union,switch_type(RPC_EPrintPropertyType)] */;
...
struct spoolss_EnumJobs {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_JobInfo **info;/* [switch_is(level),ref,size_is(,*count)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinter {
	...
	struct {
		union spoolss_PrinterInfo *info;/* [subcontext_size(offered),switch_is(level),unique,subcontext(4)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverDirectory {
	...
	struct {
		union spoolss_DriverDirectoryInfo *info;/* [unique,subcontext(4),subcontext_size(offered),switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrintProcessors {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_PrintProcessorInfo **info;/* [size_is(,*count),ref,switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumForms {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_FormInfo **info;/* [switch_is(level),size_is(,*count),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumMonitors {
	...
	struct {
		uint32_t *count;/* [ref] */
		union spoolss_MonitorInfo **info;/* [switch_is(level),ref,size_is(,*count)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrinterData {
	...
	struct {
		...
		enum winreg_Type *type;/* [ref] */
		uint8_t *data;/* [flag(LIBNDR_PRINT_ARRAY_HEX),size_is(data_offered),ref] */
...
struct spoolss_EnumPrinterKey {
	...
	struct {
		...
		union spoolss_KeyNames *key_buffer;/* [subcontext(0),subcontext_size(*_ndr_size*2),switch_is(*_ndr_size),ref] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetCorePrinterDrivers {
	struct {
		...
		const char *core_driver_dependencies;/* [size_is(core_driver_size),ref,charset(UTF16)] */
...
struct spoolss_GetPrinterDriverPackagePath {
	struct {
		...
		const char *driver_package_cab;/* [size_is(driver_package_cab_size),unique,charset(UTF16)] */
	} in;
