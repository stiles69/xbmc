...
struct NEGOTIATE_MESSAGE {
	...
	const char * DomainName;/* [subcontext(0),relative,flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),subcontext_size(DomainNameLen)] */
...
struct AV_PAIR {
	...
	union ntlmssp_AvValue Value;/* [subcontext_size(AvLen),switch_is(AvId),subcontext(0)] */
}/* [public,flag(LIBNDR_FLAG_NOALIGN)] */;

struct AV_PAIR_LIST {
	uint32_t count;
	struct AV_PAIR *pair;
}/* [nopush,nopull,gensize,flag(LIBNDR_FLAG_NOALIGN)] */;
...
struct CHALLENGE_MESSAGE {
	...
	const char * TargetName;/* [subcontext(0),relative,subcontext_size(TargetNameLen),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags))] */
	uint32_t NegotiateFlags;
...
struct AUTHENTICATE_MESSAGE {
	...
	union ntlmssp_LM_RESPONSE *LmChallengeResponse;/* [relative,subcontext_size(LmChallengeResponseLen),switch_is(LmChallengeResponseLen),subcontext(0)] */
	...
	const char * UserName;/* [subcontext(0),relative,flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext_size(UserNameLen)] */
	uint16_t WorkstationLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,Workstation))] */
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [subcontext(0),relative,subcontext_size(WorkstationLen),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags))] */
