...
union drsuapi_DsBindInfo {
	...
	struct drsuapi_DsBindInfo48 info48;/* [case(48),subcontext_size(48),subcontext(0)] */
	struct drsuapi_DsBindInfo52 info52;/* [case(52),subcontext_size(52),subcontext(0)] */
	struct drsuapi_DsBindInfoFallBack Fallback;/* [subcontext_size(48),subcontext(0),default] */
}/* [noprint,nopull,nodiscriminant,nopush] */;
...
struct drsuapi_DsGetNCChangesMSZIPCtr1 {
	...
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),subcontext_size(compressed_length),subcontext(4),unique] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesMSZIPCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [subcontext_size(compressed_length),compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),unique,subcontext(4)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr1 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr1TS *ts;/* [subcontext(4),unique,compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),subcontext_size(compressed_length)] */
}/* [nopush] */;

struct drsuapi_DsGetNCChangesXPRESSCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6TS *ts;/* [compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length),subcontext_size(compressed_length),subcontext(4),unique] */
}/* [nopush] */;
...
struct drsuapi_DsGetMemberships2 {
	...
	struct {
		uint32_t *level_out;/* [ref] */
		union drsuapi_DsGetMemberships2Ctr *ctr;/* [switch_is(*level_out),ref] */
		WERROR result;
	} out;
