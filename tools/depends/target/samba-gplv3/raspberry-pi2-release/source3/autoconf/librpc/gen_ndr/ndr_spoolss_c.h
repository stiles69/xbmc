...
struct tevent_req *dcerpc_spoolss_EnumJobs_send(TALLOC_CTX *mem_ctx,
						...
						uint32_t _offered /* [in]  */,
						uint32_t *_count /* [out] [ref] */,
						union spoolss_JobInfo **_info /* [out] [switch_is(level),ref,size_is(,*count)] */,
						uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinter_send(TALLOC_CTX *mem_ctx,
						  ...
						  DATA_BLOB *_buffer /* [in] [unique] */,
						  uint32_t _offered /* [in]  */,
						  union spoolss_PrinterInfo *_info /* [out] [subcontext_size(offered),switch_is(level),unique,subcontext(4)] */,
						  uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriverDirectory_send(TALLOC_CTX *mem_ctx,
								 ...
								 DATA_BLOB *_buffer /* [in] [unique] */,
								 uint32_t _offered /* [in]  */,
								 union spoolss_DriverDirectoryInfo *_info /* [out] [unique,subcontext(4),subcontext_size(offered),switch_is(level)] */,
								 uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_EnumPrintProcessors_send(TALLOC_CTX *mem_ctx,
							   ...
							   uint32_t _offered /* [in]  */,
							   uint32_t *_count /* [out] [ref] */,
							   union spoolss_PrintProcessorInfo **_info /* [out] [size_is(,*count),ref,switch_is(level)] */,
							   uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_EnumForms_send(TALLOC_CTX *mem_ctx,
						 ...
						 uint32_t _offered /* [in]  */,
						 uint32_t *_count /* [out] [ref] */,
						 union spoolss_FormInfo **_info /* [out] [switch_is(level),size_is(,*count),ref] */,
						 uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_EnumMonitors_send(TALLOC_CTX *mem_ctx,
						    ...
						    uint32_t _offered /* [in]  */,
						    uint32_t *_count /* [out] [ref] */,
						    union spoolss_MonitorInfo **_info /* [out] [switch_is(level),ref,size_is(,*count)] */,
						    uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_PlayGDIScriptOnPrinterIC_send(TALLOC_CTX *mem_ctx,
								...
								uint8_t *_pIn /* [in] [size_is(cIn),ref] */,
								uint32_t _cIn /* [in]  */,
								uint8_t *_pOut /* [out] [size_is(cOut),ref] */,
								uint32_t _cOut /* [in]  */,
								uint32_t _ul /* [in]  */);
...
struct tevent_req *dcerpc_spoolss_EnumPrinterData_send(TALLOC_CTX *mem_ctx,
						       ...
						       enum winreg_Type *_type /* [out] [ref] */,
						       uint8_t *_data /* [out] [flag(LIBNDR_PRINT_ARRAY_HEX),size_is(data_offered),ref] */,
...
struct tevent_req *dcerpc_spoolss_EnumPrinterKey_send(TALLOC_CTX *mem_ctx,
						      ...
						      union spoolss_KeyNames *_key_buffer /* [out] [subcontext(0),subcontext_size(*_ndr_size*2),switch_is(*_ndr_size),ref] */,
						      uint32_t _offered /* [in]  */,
						      uint32_t *_needed /* [out] [ref] */);
...
struct tevent_req *dcerpc_spoolss_GetCorePrinterDrivers_send(TALLOC_CTX *mem_ctx,
							     ...
							     const char *_core_driver_dependencies /* [in] [size_is(core_driver_size),ref,charset(UTF16)] */,
...
struct tevent_req *dcerpc_spoolss_GetPrinterDriverPackagePath_send(TALLOC_CTX *mem_ctx,
								   ...
								   const char *_driver_package_cab /* [in,out] [size_is(driver_package_cab_size),unique,charset(UTF16)] */,
