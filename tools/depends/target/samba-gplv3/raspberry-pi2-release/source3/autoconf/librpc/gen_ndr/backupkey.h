...
struct bkrp_exported_RSA_key_pair {
	...
	DATA_BLOB public_exponent;/* [subcontext_size(4),flag(LIBNDR_FLAG_REMAINING),subcontext(0)] */
	...
	DATA_BLOB private_exponent;/* [subcontext_size(256),flag(LIBNDR_FLAG_REMAINING),subcontext(0)] */
	DATA_BLOB cert;/* [subcontext_size(certificate_len),flag(LIBNDR_FLAG_REMAINING),subcontext(0)] */
};
