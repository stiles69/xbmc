...
#include "includes.h"
#include "ntdomain.h"
#include "autoconf/librpc/gen_ndr/srv_spoolss.h"
...
static bool api_spoolss_RpcSendRecvBidiData(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_spoolss.calls[NDR_SPOOLSS_RPCSENDRECVBIDIDATA];

	r = talloc(talloc_tos(), struct spoolss_RpcSendRecvBidiData);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcSendRecvBidiData, NDR_IN, r);
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcSendRecvBidiData, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_spoolss_RpcGetJobNamedPropertyValue(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_spoolss.calls[NDR_SPOOLSS_RPCGETJOBNAMEDPROPERTYVALUE];

	r = talloc(talloc_tos(), struct spoolss_RpcGetJobNamedPropertyValue);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcGetJobNamedPropertyValue, NDR_IN, r);
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcGetJobNamedPropertyValue, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_spoolss_RpcSetJobNamedProperty(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_spoolss.calls[NDR_SPOOLSS_RPCSETJOBNAMEDPROPERTY];

	r = talloc(talloc_tos(), struct spoolss_RpcSetJobNamedProperty);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcSetJobNamedProperty, NDR_IN, r);
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcSetJobNamedProperty, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_spoolss_RpcDeleteJobNamedProperty(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_spoolss.calls[NDR_SPOOLSS_RPCDELETEJOBNAMEDPROPERTY];

	r = talloc(talloc_tos(), struct spoolss_RpcDeleteJobNamedProperty);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcDeleteJobNamedProperty, NDR_IN, r);
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcDeleteJobNamedProperty, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static bool api_spoolss_RpcEnumJobNamedProperties(struct pipes_struct *p)
{
	const struct ndr_interface_call *call;
	struct ndr_pull *pull;
	struct ndr_push *push;
	...
	call = &ndr_table_spoolss.calls[NDR_SPOOLSS_RPCENUMJOBNAMEDPROPERTIES];

	r = talloc(talloc_tos(), struct spoolss_RpcEnumJobNamedProperties);
	if (r == NULL) {
		return false;
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcEnumJobNamedProperties, NDR_IN, r);
	}
	...
	if (DEBUGLEVEL >= 10) {
		NDR_PRINT_FUNCTION_DEBUG(spoolss_RpcEnumJobNamedProperties, NDR_OUT | NDR_SET_VALUES, r);
	}
...
static struct api_struct api_spoolss_cmds[] = 
{
	...
	{"SPOOLSS_RPCSENDRECVBIDIDATA", NDR_SPOOLSS_RPCSENDRECVBIDIDATA, api_spoolss_RpcSendRecvBidiData},
	...
	{"SPOOLSS_RPCGETJOBNAMEDPROPERTYVALUE", NDR_SPOOLSS_RPCGETJOBNAMEDPROPERTYVALUE, api_spoolss_RpcGetJobNamedPropertyValue},
	{"SPOOLSS_RPCSETJOBNAMEDPROPERTY", NDR_SPOOLSS_RPCSETJOBNAMEDPROPERTY, api_spoolss_RpcSetJobNamedProperty},
	{"SPOOLSS_RPCDELETEJOBNAMEDPROPERTY", NDR_SPOOLSS_RPCDELETEJOBNAMEDPROPERTY, api_spoolss_RpcDeleteJobNamedProperty},
	{"SPOOLSS_RPCENUMJOBNAMEDPROPERTIES", NDR_SPOOLSS_RPCENUMJOBNAMEDPROPERTIES, api_spoolss_RpcEnumJobNamedProperties},
};
