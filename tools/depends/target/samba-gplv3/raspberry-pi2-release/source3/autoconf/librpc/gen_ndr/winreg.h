...
struct winreg_StringBuf {
	...
	uint16_t size;
	const char *name;/* [charset(UTF16),unique,size_is(size/2),length_is(length/2)] */
};
...
struct winreg_EnumValue {
	struct {
		...
		uint8_t *value;/* [size_is(size?*size:0),length_is(length?*length:0),range(0,0x4000000),unique] */
...
struct winreg_QueryValue {
	struct {
		...
		enum winreg_Type *type;/* [unique] */
		uint8_t *data;/* [unique,size_is(data_size?*data_size:0),length_is(data_length?*data_length:0),range(0,0x4000000)] */
...
struct winreg_QueryMultipleValues2 {
	struct {
		struct policy_handle *key_handle;/* [ref] */
		struct QueryMultipleValue *values_in;/* [ref,size_is(num_values),length_is(num_values)] */
		uint32_t num_values;
		uint32_t *offered;/* [ref] */
		uint8_t *buffer;/* [unique,size_is(*offered),length_is(*offered)] */
	} in;
