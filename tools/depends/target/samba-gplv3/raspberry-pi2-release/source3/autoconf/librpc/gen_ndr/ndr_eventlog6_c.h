...
struct tevent_req *dcerpc_eventlog6_EvtRpcClearLog_send(TALLOC_CTX *mem_ctx,
							...
							const char *_backupPath /* [in] [charset(UTF16),unique,range(0,MAX_RPC_FILE_PATH_LENGTH)] */,
							uint32_t _flags /* [in]  */,
							struct eventlog6_RpcInfo *_error /* [out] [ref] */);
...
struct tevent_req *dcerpc_eventlog6_EvtRpcGetChannelList_send(TALLOC_CTX *mem_ctx,
							      ...
							      const char ***_channelPaths /* [out] [charset(UTF16),ref,range(0,MAX_RPC_CHANNEL_COUNT),size_is(,*numChannelPaths)] */);
...
struct tevent_req *dcerpc_eventlog6_EvtRpcGetPublisherList_send(TALLOC_CTX *mem_ctx,
								...
								const char ***_publisherIds /* [out] [ref,range(0,MAX_RPC_PUBLISHER_COUNT),size_is(,*numPublisherIds),charset(UTF16)] */);
...
struct tevent_req *dcerpc_eventlog6_EvtRpcGetEventMetadataEnum_send(TALLOC_CTX *mem_ctx,
								    ...
								    uint32_t _flags /* [in]  */,
								    const char *_reservedForFilter /* [in] [range(0,MAX_RPC_FILTER_LENGTH),charset(UTF16),unique] */,
