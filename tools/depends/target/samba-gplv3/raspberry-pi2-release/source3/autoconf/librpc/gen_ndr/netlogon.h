...
struct netr_CIPHER_VALUE {
	uint32_t len;
	uint32_t maxlen;
	uint8_t *cipher_data;/* [unique,size_is(maxlen),length_is(len)] */
};
...
struct netr_OsVersionInfoEx {
	...
	uint32_t PlatformId;
	const char * CSDVersion;/* [subcontext_size(256),flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2),subcontext(0)] */
