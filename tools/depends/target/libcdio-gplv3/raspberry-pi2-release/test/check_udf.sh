...
if test "X$abs_top_srcdir" = "X" ; then
  abs_top_srcdir=/root/kodi/tools/depends/target/libcdio-gplv3/raspberry-pi2-release
fi

if test "X$top_builddir" = "X" ; then
  top_builddir=/root/kodi/tools/depends/target/libcdio-gplv3/raspberry-pi2-release
fi
